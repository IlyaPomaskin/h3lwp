...
class LodSpriteLoader {
     ...
     */
    internal fun applySpecialPalette(originalPalette: ByteArray): Pair<ByteArray, ByteArray> {
    ...
    internal val terrainDefNames = setOf(
    ...
    fun loadSprites(
        ...
        if (archive.isHota18) {
            return Hota18SpriteLoader(this).loadSprites(lodReader, archive, neededNames, packer, onProgress)
        }
